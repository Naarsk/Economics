...
\section{Case Study}\label{sec:case-study}
    ...
    For this GP, 810 documents have been processed, including the document I will pick as an example, \texit{1047 - Oregon Public Employees Retirement Fund Opportunity Portfolio}, which details the performance of several funds in which the Oregon Public Employees Retirement Fund is invested, managed by TPG\@.
