...
class RamseyModel:
    ...
    def __init__(self, depreciation_rate, discounting_rate, starting_capital, utility_function, production_function,
    ...
    def __call__(self):
        ...
        for t in self.time[:-1]:
            ...
            self.elasticity[t] = - nd.Derivative(self.utility_function,order=2)(self.consumption[t])/nd.Derivative(self.utility_function,order=1)(self.consumption[t]) * self.consumption[t]
